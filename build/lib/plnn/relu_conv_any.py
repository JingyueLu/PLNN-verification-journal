...
from plnn.bounds_analysis import bounds_analysis
...
def relu_bab(net, domain,  x, ball_eps, eps=1e-4, pgd_threshold = 0.25, decision_bound=None):
    '''
    ...
    while global_ub - global_lb > eps:
        ...
        #icp_score =2
        branching_decision, icp_score = choose_node_conv(orig_lbs, orig_ubs, mask, net.layers, pre_relu_indices, icp_score)
        ...
        for choice in [0,1]:
            ...
            dom_ub,dom_lb, dom_ub_point, updated_mask, dom_lb_all, dom_ub_all, dom_dual_info= net.get_lower_bound( mask_temp, orig_lbs, orig_ubs, branching_decision, choice, orig_dual)
